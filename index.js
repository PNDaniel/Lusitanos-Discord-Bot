...
client.on('message', async msg => {
	...
	if (TWCity1.includes(msg.content.toLowerCase().normalize("NFD").replace(/\p{Diacritic}/gu, "").replace("/", "")) && msg.content.includes("/")) {
		...
		xmlHttp.open("GET", "https://drive.google.com/uc?id=1e8j9GvtYrdf-qhNGJ-TAUi78YuPgi63A", true); // true for asynchronous 
		xmlHttp.send(null);
		
		if (msg.member.roles.cache.some(role => role.name === 'Conselho'))
			msg.channel.send({
				files: ["https://doc-0s-3s-docs.googleusercontent.com/docs/securesc/dtebphg3vv0hi841gg5lgh1lb58dig6q/77jau2ub0u435nh46erm7kh206ss3db8/1655030700000/17595197152808051891/17595197152808051891/1e8j9GvtYrdf-qhNGJ-TAUi78YuPgi63A?ax=ACxEAsbfABUxkpjz9eAvYyd9SgfFL1oON14GGTZqRmjad3amIrPYYgcDOK3LGdQYI16QuceqU7PHHOpb7F8yzZLXsvSsJpnqpL45R_9wjFJB8kce_iucWqsgbmBdXFeUOVcw-nlE3kCFpTBuH3G_fQDlPnwtmXpheLLUAkvpuYdQD8QyVoJQFV7uxTPUBn63e6NsAH2O_IpvNcm0uNpiOqzXjuxW3nguNocg99atdtQxhs3-TH2kh1KkjDDjEqltsZtiCVCeaIFRI5yfAfQPakH5rN_6BCwvcXfNcK1443XN5XYIaE4L9aiTnf0NjdHQKEuc5o13UD7WQsxWLYX2jjvnm6SArg4Cfu84J5nmApCJd0oCJmS76aAXo5pvv9qpG_ts48DebTb_eZ9vFpYMAK3sHbEsqiUz_kAJAC7VO-He9FpRKnC3oyiBXS_zs8LgURN0fxdIbsEhYcL2_f0IPxf5sDri4qzCKrouN4wp9Z9ZmMNRm7WWpcP9HapZ3O7658eJZjnc7yCstEBYxMHWi9qGP7lut4hGF35JC2tLWPUNNRq4EKBW6Xu95GOekFvpIIG11uR0xo9xPcS2yAJVvXUwWjsBHyAkyRsoEqUP_w0fwDqh8rNYm1lzFCyblYulK6Sx933_8gm_j7rHyMup5GaNK7oqPaAjUbvrJC6FJzgA9qobRJxXIqomrhWqWT7lJy80QaDtuQHGwv00Z_yx2k78b3w4J0l9WA9YGQT9ZCZBIbhtPSz4Us_-aWFm_tca5gg9FUwDEdnws5J0YxMufajOAYYICa9rcusjwZy6225CM3kN3heutEMSLbfLhZ6Odo5VM8KkRj8OEjXkjotakbznTFO94E_6yCm42snDJZdwWNHzy33uzFzxkKGQO9TnilY&authuser=0&nonce=bg2su7at7gje2&user=17595197152808051891&hash=pv6af3lcm1dmo8dj60s5ku170bhupj58.png"]
			});
	}
